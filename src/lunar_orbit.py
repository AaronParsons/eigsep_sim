...
DEPRECATION NOTICE: :func:`circular_orbital_period` and :class:`LunarOrbit`
have been moved to :mod:`observer`. Import from there instead:

    from eigsep_sim.observer import LunarOrbit, circular_orbital_period
...
from .observer import LunarOrbit, circular_orbital_period, ICRS2GAL
from .const import c as _C
from .beam import (
